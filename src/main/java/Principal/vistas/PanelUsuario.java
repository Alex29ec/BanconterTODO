...
import Principal.controlador.ControladorUsuario;
...
public class PanelUsuario extends JPanel {
	...
	public void buscar() {
		...
		if (rdbtnApellido.isSelected()) {
			usuariosParaLista = (List<Usuario>) ControladorUsuario.getInstance().findbyString(
					this.jtfBusqueda.getText(), "usuario", "apellido", this.chckbxCaseSensitive.isSelected());
		}
		if (rdbtnNombre.isSelected()) {
			usuariosParaLista = (List<Usuario>) ControladorUsuario.getInstance().findbyString(
					this.jtfBusqueda.getText(), "usuario", "nombreUsuario", this.chckbxCaseSensitive.isSelected());
		}
